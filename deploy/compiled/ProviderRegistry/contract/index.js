...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerProvider: (...args_1) => {
        if (args_1.length !== 6) {
          throw new __compactRuntime.CompactError(`registerProvider: expected 6 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const provider_id_0 = args_1[1];
        const pubkey_0 = args_1[2];
        const endpoint_0 = args_1[3];
        const model_0 = args_1[4];
        const price_0 = args_1[5];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerProvider',
                                     'argument 1 (as invoked from Typescript)',
                                     'ProviderRegistry.compact line 17 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(provider_id_0).concat(_descriptor_0.toValue(pubkey_0).concat(_descriptor_4.toValue(endpoint_0).concat(_descriptor_4.toValue(model_0).concat(_descriptor_2.toValue(price_0))))),
            alignment: _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_4.alignment().concat(_descriptor_4.alignment().concat(_descriptor_2.alignment()))))
          },
          output: undefined,
          publicTranscript: [],
      ...
      deregisterProvider: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`deregisterProvider: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const provider_id_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('deregisterProvider',
                                     'argument 1 (as invoked from Typescript)',
                                     'ProviderRegistry.compact line 37 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(provider_id_0.buffer instanceof ArrayBuffer && provider_id_0.BYTES_PER_ELEMENT === 1 && provider_id_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(provider_id_0),
        ...
        const result_0 = this._deregisterProvider_0(context,
                                                    partialProofData,
                                                    provider_id_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      ...
      updateReputation: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const provider_id_0 = args_1[1];
        const new_rep_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('updateReputation',
                                     'argument 1 (as invoked from Typescript)',
                                     'ProviderRegistry.compact line 44 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(provider_id_0.buffer instanceof ArrayBuffer && provider_id_0.BYTES_PER_ELEMENT === 1 && provider_id_0.length === 32)) {
        ...
        if (!(typeof(new_rep_0) === 'bigint' && new_rep_0 >= 0n && new_rep_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('updateReputation',
                                     'argument 2 (argument 3 as invoked from Typescript)',
                                     'ProviderRegistry.compact line 44 char 1',
                                     'Uint<0..18446744073709551616>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(provider_id_0).concat(_descriptor_2.toValue(new_rep_0)),
    ...
    this.impureCircuits = {
      ...
      deregisterProvider: this.circuits.deregisterProvider,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('deregisterProvider', new __compactRuntime.ContractOperation());
                      ...
                      price_0)
  {
    ...
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(pub_id_0),
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(pub_id_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(endpoint_0),
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(pub_id_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(model_0),
                                                                                              alignment: _descriptor_4.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
  ...
  _deregisterProvider_0(context, partialProofData, provider_id_0) {
    const pub_id_0 = provider_id_0;
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
    ...
    __compactRuntime.assert(this._equal_0(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { idx: { cached: false,
                                                                                                              ...
                                                                                                              path: [
                                                                                                                     { tag: 'value',
                                                                                                                       value: { value: _descriptor_0.toValue(pub_id_0),
                                                                                                                                alignment: _descriptor_0.alignment() } }] } },
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
  ...
  _updateReputation_0(context, partialProofData, provider_id_0, new_rep_0) {
    const pub_id_0 = provider_id_0;
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(pub_id_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(new_rep_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    return [];
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'ProviderRegistry.compact line 9 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    provider_endpoint: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'ProviderRegistry.compact line 10 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    provider_model: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'ProviderRegistry.compact line 11 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    provider_price: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'ProviderRegistry.compact line 12 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    provider_reputation: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'ProviderRegistry.compact line 13 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    provider_active: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'ProviderRegistry.compact line 14 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    provider_owner: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'ProviderRegistry.compact line 15 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
